## [2.3.7] — 2026-06-08 22:05

### 🐛 修复
- 顺序练习进度按题号位置(currentIndex)计算而非已答题数
- pre-commit hook中date命令引号修复，兼容Windows

### 🎨 UI
- 首页卡片间距统一，练习进度实时刷新(每5秒)
...
### 🚀 新增功能
- 考试倒计时模块：准考证下载、考试、成绩查询三个阶段的倒计时提醒
- 考试题量调整为60单选+100多选+40判断，每题0.5分，满分100分

### 🎨 UI
- 合格线从60分调整为80分（80/100）
- 首页新增考试倒计时卡片
...
## [2.3.4] — 2026-06-08 21:30

### 🐛 修复
- 分数计算不准：正确率分母从已答数改为总题数，确保与分数圈一致
- 随机练习的进度不再与顺序练习共享存储

### 🔧 技术改进
- 新增记忆规则：修复代码前必须先完整阅读理解逻辑

## [2.3.3] — 2026-06-07 11:55

### 🚀 新增功能
- 顺序练习退出后保留进度记忆，重新进入时弹窗选择继续或重新开始

### 🔧 技术改进
- 新增 PracticeProgressStore：基于SharedPreferences持久化练习进度

## [2.3.2] — 2026-06-07 11:30

### 🐛 修复
- 考试详情页选项间空白区域过大：改用Surface+CeterVertically对齐，统一行高
- 关于页更新日志按钮改为CHANGELOG外部链接
- 关于页新增检查更新按钮
- 分享图片内容优化，包含完整考试详情

## [2.3.1] — 2026-06-07 11:10
